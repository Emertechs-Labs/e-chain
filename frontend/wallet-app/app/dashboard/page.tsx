...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      ...
      {/* Header */}
      <header className="bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 shadow-lg border-b border-white/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link href="/" className="text-xl font-bold text-white hover:text-cyan-200 transition-colors">
                Echain Wallet
              </Link>
            </div>
            <nav className="flex space-x-4">
              ...
              <Suspense fallback={<div className="h-6 w-16 bg-white/20 rounded animate-pulse"></div>}>
                <NetworkBadge network={network} />
              </Suspense>
              <button
                onClick={handleFarcasterLogin}
                className="ml-4 px-3 py-2 bg-purple-500/80 text-white rounded-lg font-medium hover:bg-purple-400 transition-colors text-sm backdrop-blur-sm"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 flex gap-4">
          <button
            ...
            className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-6 py-3 rounded-lg font-medium hover:from-blue-700 hover:to-cyan-700 transition-all duration-200 flex items-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
          ...
          <Link
            ...
            className="border-2 border-gray-300 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-lg font-medium hover:bg-white hover:border-gray-400 transition-all duration-200 flex items-center gap-2 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="lg:col-span-1">
            <Suspense fallback={<div className="h-48 bg-white/60 backdrop-blur-sm rounded-xl animate-pulse shadow-lg"></div>}>
              <BalanceDisplay
                config={hederaConfig}
                accountId={accountId}
                autoRefresh={true}
                refreshInterval={10000}
                onBalanceUpdate={(balance: number, tokens: any) => {
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1">
        ...
        {/* Transaction History */}
        <div className="mt-6">
          <Suspense fallback={<div className="h-96 bg-white/60 backdrop-blur-sm rounded-xl animate-pulse shadow-lg"></div>}>
            <TransactionHistory
        ...
        {/* Help Section */}
        <div className="mt-6 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200/50 rounded-xl p-6 shadow-lg">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>Sign in with Farcaster for social features</li>
